          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">About Us</a></li>
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">How It Works</a></li>
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">FAQ</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-4">Legal</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">Privacy Policy</a></li>
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">Terms of Service</a></li>
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">Contact Us</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-4">Connect</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">Twitter</a></li>
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">LinkedIn</a></li>
                <li><a href="#" className="text-zinc-400 hover:text-yellow-500">Facebook</a></li>
              </ul>
            </div>
          </div>
